...
const EngMain = () => {
  ...
  useEffect(() => {
    const fetchSections = () => {
      const sectionsCollection = collection(db, "engineering");
  ...
  const handleSave = async () => {
    ...
    Object.keys(sections).forEach((section) => {
      const sectionRef = doc(db, "engineering", section);
          ...
          <div className='lg:w-[400px] w-full' key={section}>
            ...
            <div className='mt-5 flex flex-col'>
              ...
              <div className='mt-5 flex items-center gap-2 font-poppins'>
                <Link to={`/engineering/${section}`} className='font-semibold text-blue-600'>
                  Learn More
                </Link>
                <img
                  src={arrow}
